...
@Component({
  selector: 'app-detail-related-post',
  templateUrl: './detail-related-post.component.html',
  styleUrls: ['./detail-related-post.component.scss'],
})
export class DetailRelatedPostComponent implements OnInit {
